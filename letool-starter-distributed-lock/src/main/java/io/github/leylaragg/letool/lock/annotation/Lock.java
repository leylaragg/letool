 ...
 * 在方法执行后（无论成功或异常）释放锁。获取锁失败时抛出 {@link io.github.leylaragg.letool.lock.exception.LockException}。</p>
 *
 * <h3>使用示例</h3>
 * <pre>{@code
 ...
 *   <li>底层委托给 {@link io.github.leylaragg.letool.lock.core.LockTemplate}</li>
 * </ul>
 *
 * @author leyland
 * @since 1.0.0
 * @see io.github.leylaragg.letool.lock.aspect.LockAspect
 * @see io.github.leylaragg.letool.lock.core.LockTemplate
 */
...
public @interface Lock {
     ...
     * 等待获取锁的最长时间（默认 3 秒）。
     *
     * <p>超过此时间仍未获取到锁则抛出 {@link io.github.leylaragg.letool.lock.exception.LockException}。</p>
     *
     * @return 等待时间数值
     */

...
class FunctionEvaluationTest {
    ...
    void shouldWrapRuleEngineExceptionThrownByFunction() {
        com.github.leyland.letool.ruleengine.exception.RuleEngineException original =
                com.github.leyland.letool.ruleengine.exception.RuleEngineException.invalidArgument();
        FunctionRegistry registry = FunctionRegistry.builder()

...
final class CompiledCondition {
    ...
    /** 创建不包含业务值的安全绑定异常。 */
    private static com.github.leyland.letool.print.exception.PrintValidationException bindingError(
            CompiledXmlNode node, String templateCode, String detail) {
        return com.github.leyland.letool.print.exception.PrintValidationException.invalidDocument(

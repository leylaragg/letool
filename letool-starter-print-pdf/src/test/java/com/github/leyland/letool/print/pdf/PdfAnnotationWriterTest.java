...
class PdfAnnotationWriterTest {
    ...
    void shouldAcceptAnnotationCountAtLimit() {
        List<com.github.leyland.letool.print.document.node.BlockNode> blocks = new ArrayList<>();
    ...
    void shouldUseFirstVisiblePageOfSpanningTarget() throws Exception {
        List<com.github.leyland.letool.print.document.node.BlockNode> children = new ArrayList<>();

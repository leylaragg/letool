package io.github.leylaragg.letool.websocket.room;

import io.github.leylaragg.letool.tool.json.Fastjson2JsonCodec;
import io.github.leylaragg.letool.websocket.core.WsDeliveryResult;
...
public class WsRoomManager {
    ...
    private final io.github.leylaragg.letool.websocket.core.WsMessageCodec messageCodec;
    ...
    public WsRoomManager(WsSessionManager sessionManager) {
        this(sessionManager, new io.github.leylaragg.letool.websocket.core.WsMessageCodec(
    ...
    public WsRoomManager(
            ...
            io.github.leylaragg.letool.websocket.core.WsMessageCodec messageCodec) {

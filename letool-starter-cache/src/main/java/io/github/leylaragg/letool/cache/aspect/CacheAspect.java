package io.github.leylaragg.letool.cache.aspect;

import io.github.leylaragg.letool.cache.annotation.MultiLevelCacheEvict;
import io.github.leylaragg.letool.cache.annotation.MultiLevelCachePut;
import io.github.leylaragg.letool.cache.annotation.MultiLevelCacheable;
import io.github.leylaragg.letool.cache.consistency.CacheMutationCoordinator;
import io.github.leylaragg.letool.cache.consistency.CacheMutation;
...
public class CacheAspect {
    ...
    private Object executeMutation(
        ...
        if (cache.getConsistencyMode()
                == io.github.leylaragg.letool.cache.consistency.CacheConsistencyMode.DURABLE) {

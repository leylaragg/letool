-- =============================================
-- Database 包 MySQL 测试数据脚本
-- =============================================

-- 创建测试数据库
CREATE DATABASE IF NOT EXISTS letool_test DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE letool_test;
...
CREATE TABLE IF NOT EXISTS outpat_record (
    ...
    visit_date TIMESTAMP NULL COMMENT '就诊日期',
...
CREATE TABLE IF NOT EXISTS inpat_record (
    ...
    admission_date TIMESTAMP NULL COMMENT '入院日期',
    discharge_date TIMESTAMP NULL COMMENT '出院日期',
    dept_name VARCHAR(100) COMMENT '科室名称',
...
CREATE TABLE IF NOT EXISTS lab_report (
    ...
    test_time TIMESTAMP NULL COMMENT '检验时间',
    report_time TIMESTAMP NULL COMMENT '报告时间',
    status TINYINT DEFAULT 1 COMMENT '状态：1-正常, 0-删除',
    INDEX idx_patient_id (patient_id),
...
CREATE TABLE IF NOT EXISTS exam_report (
    ...
    exam_time TIMESTAMP NULL COMMENT '检查时间',
    report_time TIMESTAMP NULL COMMENT '报告时间',
    status TINYINT DEFAULT 1 COMMENT '状态：1-正常, 0-删除',
    INDEX idx_patient_id (patient_id),

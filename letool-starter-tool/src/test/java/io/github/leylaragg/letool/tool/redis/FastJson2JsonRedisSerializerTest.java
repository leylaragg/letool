...
import io.github.leylaragg.letool.tool.redis.allowed.AllowedValue;
import io.github.leylaragg.letool.tool.redis.allowedevil.LookalikeValue;
...
class FastJson2JsonRedisSerializerTest {
    ...
    void shouldUseConfiguredAutoTypeAcceptPrefixes() {
        FastJson2JsonRedisSerializer<Object> serializer = new FastJson2JsonRedisSerializer<>(
                Object.class,
                "io.github.leylaragg.letool.tool.redis"
        );
        TestUser user = new TestUser();
        user.setId("u2");
    ...
    void shouldAcceptOnlyClassesInsideConfiguredPackageBoundary() {
        FastJson2JsonRedisSerializer<Object> serializer = new FastJson2JsonRedisSerializer<>(
                Object.class,
                "io.github.leylaragg.letool.tool.redis.allowed"
        );
